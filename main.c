...
int LinuxStart_msgOK(char *msg, char*cmd)
{
  ...
  else if (msg[0] == 'S'  && msg[1] == 'S' && msg[2] == 'H')return FALSE;
  else if (msg[0] == '\\' && msg[1] == 'S')return FALSE;
  else if (msg[0] == 'T'  && msg[1] == 'h' && msg[2] == 'i' && msg[3] == 's' && msg[4] == ' ')return FALSE;
  else if (msg[0] == 'T'  && msg[1] == 'h' && msg[2] == 'e' && msg[3] == ' ')return FALSE;
  else if (msg[0] == 'A'  && msg[1] == 'u' && msg[2] == 'd' && msg[3] == 'i' && msg[4] == 't')return FALSE;
  else if (msg[0] == 'D' && msg[1] == 'E' && msg[2] == 'L' && msg[3] == 'I' && msg[4] == 'V' && msg[5] == 'E' && msg[6] == 'R')return FALSE;
  else if (msg[0] == 'A' && msg[1] == 'u' && msg[2] == 't' && msg[3] == 'h' && msg[4] == ' ' && msg[5] == 'U' && msg[6] == 's')return -1;
